    ...
    <main className="flex flex-col items-center p-10">
      ...
      <div className="flex">
        <iframe
          width="450"
          height="260"
          src="https://thingspeak.com/channels/2299528/charts/1?bgcolor=%23fefefe&color=%23d62020&dynamic=true&results=10&type=line&update=15"
        ></iframe>

        <iframe
          width="450"
          height="260"
          src="https://thingspeak.com/channels/2299528/charts/2?bgcolor=%23fefefe&color=%23d62020&dynamic=true&results=10&type=line&update=15"
        ></iframe>
      </div>
      ...
      <div>
        <iframe
          width="450"
          height="260"
          src="https://thingspeak.com/channels/2299528/charts/3?bgcolor=%23fefefe&color=%23d62020&dynamic=true&results=10&type=line&update=15"
        ></iframe>
      </div>
